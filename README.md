...
Скрипт создает JSON файл со следующей структурой:
...
#### **Docker:**
- **JSON файл** с данными: `./data/russia_regions_YYYY-MM-DD.json` (на хосте)
- **Логи** для анализа: `./logs/` (3 файла логов на хосте)
- **Volume mapping** - файлы автоматически доступны на вашем компьютере

#### **Локально:**
- **JSON файл** с данными: `./data/russia_regions_YYYY-MM-DD.json`
...
- ⏱️ **Время выполнения** - несколько часов (85+ регионов)
